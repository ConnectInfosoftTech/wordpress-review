...
<div class="fusion-header-content-3-wrapper">
	...
	<?php elseif ( 'Search' === $header_content_3 ) : ?>
		<div class="fusion-secondary-menu-search header-top">
			<?php if ( function_exists( 'woo_predictive_search_widget' ) ) woo_predictive_search_widget( true ); else get_search_form( true ); ?>
		</div>
