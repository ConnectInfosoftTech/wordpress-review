	...
	return function () {
		...
		this.init = function (ele) {
			...
			*/
			...
			overlay.bind(((document.ontouchstart !== null) ? 'mousedown':'touchstart'), function (e) {
				...
				jQuery(document).bind(((document.ontouchmove !== null) ? 'mousemove':'touchmove'), function (e) {
				...
				jQuery(document).bind(((document.ontouchend !== null) ? 'mouseup':'touchend'), function (e) {



					jQuery(document).unbind(((document.ontouchmove !== null) ? 'mousemove':'touchmove'));
		...
		*/
		...
		this.slider = function () {
			...
			jQuery(this.settings.slider).noUiSlider({
